...
public class UserProfileViewController {
	...
	@GetMapping(value="/users/{userId}/profile", produces="application/json;charset=utf8")
	public DeferredResult<ResponseEntity<ApiResponse>> handleRequest(@PathVariable Long userId, ApiRequest requestParam, Locale locale )  {
		long timeout = 15000L;
